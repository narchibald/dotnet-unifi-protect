namespace UniFi.Protect.Api
{
    ...
    public class Protect : IProtect
    {
        ...
        public string NvrName => this.bootstrap?.Nvr != null ? this.bootstrap.Nvr.Name + " [" + this.bootstrap.Nvr.Type + "]" : this.configuration.NvrAddress.Host;
        ...
        private bool CheckAdminUserStatus(bool firstRun = false)
        {
            ...
            {
                LogInformation($"The user '{this.configuration.Username}' requires the Administrator role in order to automatically configure camera RTSP streams.");
            }
